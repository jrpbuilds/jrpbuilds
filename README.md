...
Programmer & software engineer in Birmingham, UK.
...
I build software, infrastructure and developer tooling — usually close enough to production that Linux, networks, databases, security and deployment are part of the same problem.
